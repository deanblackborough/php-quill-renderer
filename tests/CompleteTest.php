...
/**
 * Test a complete delta string with all currently supported attributes
 */
final class CompleteTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $this->assertTrue($this->renderer->load($this->deltas), __METHOD__ . ' failed');
    }

    public function testHtmlValid()
    {
        ...
        $this->renderer->load($this->deltas);

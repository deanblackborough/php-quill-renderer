...
* List item 2';
    ...
    public function testListOrdered()
    {
        ...
        try {
            $quill = new QuillRender($this->delta_ordered, OPTIONS::FORMAT_GITHUB_MARKDOWN);
            $result = $quill->render();
        } catch (\Exception $e) {
    ...
    public function testListBullet()
    {
        ...
        try {
            $quill = new QuillRender($this->delta_unordered, OPTIONS::FORMAT_GITHUB_MARKDOWN);
            $result = $quill->render();
        } catch (\Exception $e) {
            $this->fail(__METHOD__ . 'failure, ' . $e->getMessage());
        }
    ...
    public function testListWithAttribute()
    {
        ...
        try {
            $quill = new QuillRender($this->delta_list_with_attribute, OPTIONS::FORMAT_GITHUB_MARKDOWN);
            $result = $quill->render();
        } catch (\Exception $e) {
            $this->fail(__METHOD__ . 'failure, ' . $e->getMessage());
        }
    ...
    public function testSingleListItemBold()
    {
        ...
        try {
            $quill = new QuillRender($this->delta_single_item_list_bold, OPTIONS::FORMAT_GITHUB_MARKDOWN);
            $result = $quill->render();
        } catch (\Exception $e) {
            $this->fail(__METHOD__ . 'failure, ' . $e->getMessage());
        }
    ...
    public function testSingleListItemItalic()
    {
        ...
        try {
            $quill = new QuillRender($this->delta_single_item_list_italic, OPTIONS::FORMAT_GITHUB_MARKDOWN);
            $result = $quill->render();
        } catch (\Exception $e) {
            $this->fail(__METHOD__ . 'failure, ' . $e->getMessage());
        }
    ...
    public function testSingleListItemLink()
    {
        ...
        try {
            $quill = new QuillRender($this->delta_single_item_list_link, OPTIONS::FORMAT_GITHUB_MARKDOWN);
            $result = $quill->render();
        } catch (\Exception $e) {
            $this->fail(__METHOD__ . 'failure, ' . $e->getMessage());
        }

...
final class HeaderTest extends \PHPUnit\Framework\TestCase
{
    ...
    public function testHeader1()
    {
        ...
        try {
            $quill = new QuillRender($this->delta_h1, OPTIONS::FORMAT_GITHUB_MARKDOWN);
            $result = $quill->render();
        } catch (\Exception $e) {
    ...
    public function testHeader2()
    {
        ...
        try {
            $quill = new QuillRender($this->delta_h2, OPTIONS::FORMAT_GITHUB_MARKDOWN);
            $result = $quill->render();
        } catch (\Exception $e) {
            $this->fail(__METHOD__ . 'failure, ' . $e->getMessage());
        }
    ...
    public function testHeader3()
    {
        ...
        try {
            $quill = new QuillRender($this->delta_h3, OPTIONS::FORMAT_GITHUB_MARKDOWN);
            $result = $quill->render();
        } catch (\Exception $e) {
            $this->fail(__METHOD__ . 'failure, ' . $e->getMessage());
        }
    ...
    public function testHeader4()
    {
        ...
        try {
            $quill = new QuillRender($this->delta_h4, OPTIONS::FORMAT_GITHUB_MARKDOWN);
            $result = $quill->render();
        } catch (\Exception $e) {
            $this->fail(__METHOD__ . 'failure, ' . $e->getMessage());
        }
    ...
    public function testHeader5()
    {
        ...
        try {
            $quill = new QuillRender($this->delta_h5, OPTIONS::FORMAT_GITHUB_MARKDOWN);
            $result = $quill->render();
        } catch (\Exception $e) {
            $this->fail(__METHOD__ . 'failure, ' . $e->getMessage());
        }
    ...
    public function testHeader6()
    {
        ...
        try {
            $quill = new QuillRender($this->delta_h6, OPTIONS::FORMAT_GITHUB_MARKDOWN);
            $result = $quill->render();
        } catch (\Exception $e) {
            $this->fail(__METHOD__ . 'failure, ' . $e->getMessage());
        }
    ...
    public function testHeader7()
    {
        ...
        try {
            $quill = new QuillRender($this->delta_h7, OPTIONS::FORMAT_GITHUB_MARKDOWN);
            $result = $quill->render();
        } catch (\Exception $e) {
            $this->fail(__METHOD__ . 'failure, ' . $e->getMessage());
        }

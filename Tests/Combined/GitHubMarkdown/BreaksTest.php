...
{
    private $delta_paragraphs_with_attributes = '
    {
        "ops":[
            {
                "insert":"This is a three "
            },
            {
                "attributes":{
                    "bold":true
    ...
    private $expected_paragraphs_with_attributes =
"This is a three **paragraph** test
